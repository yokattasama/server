...
// 今日出催额排名
const todayEndCollectionRank = [
  {
    name: '赵月',
    key: 1,
    endCollectionAmount: 15352.64,
    endCollectionCount: 11,
    rank: 1,
  },
  {
    name: '一月',
...
// 坐席绩效指标排名
const seatsMeritRank = [
  {
    name: '赵月',
    key: 1,
    backRate: '89%',
    repayAmount: 15352.64,
    rank: 1,
  },
  {
    name: '一月',
...

  {
    ...
    key: 8,
    backRate: '82%',
    repayAmount: 15345.64,
    rank: 8,
  },{
    name: '八月',
    key: 9,
    backRate: '81%',
    repayAmount: 15344.64,
    rank: 9,
  },
...
const dataSource = [
  {
    id: '1',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；1',
    accuracy: '80',
  },
  {
    id: '2',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；2',
    accuracy: '90'
  },
  {
    id: '3',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；3',
    accuracy: '90'
  },
  {
    id: '4',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；4',
    accuracy: '90'
  },
  {
    id: '5',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；5',
    accuracy: '80'
  },
  {
    id: '6',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；6',
    accuracy: '80'
  },
  {
    id: '7',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；7',
    accuracy: '80'
  },
  {
    id: '8',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；8',
    accuracy: '90'
  },
  {
    id: '9',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；9',
    accuracy: '90'
  },
  {
    id: '10',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；10',
    accuracy: '90'
  },
  {
    id: '11',
    content: '我真的没有办理/激活/开通过你说的那张卡片/业务；11',
    accuracy: '90'
  },
]
// 语义分类大类
...
const _cates = cates.splice(0,14)
...
app.get('/onlinecount', (req, res) => res.send(onlinecount))
app.get('/endCollectionDetail',(req, res) => res.send(endCollectionDetail))
app.get('/todayEndCollectionRank',(req, res) => {
  setTimeout(()=>{
    res.send(todayEndCollectionRank)
  },2000)
})
app.get('/seatsMeritRank',(req, res) => res.send(seatsMeritRank))
app.get('/richList',(req, res) => res.send(richList))
